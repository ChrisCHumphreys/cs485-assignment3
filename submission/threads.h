...
/**
 * @brief Prints info about threads, and calls threaded functions based on mode.
 *
...
/**
 *  @brief Creates and runs threads based on mode.
 *
...
/**
 * @brief Reads the balance, increases it by 10, sleeps, and then updates the
 *        balance.
 * 
...
/**
 * @brief Adds 100 to bank account
 *
...
/**
 * @brief Subtracts 100 from bank account
 *
 * This function takes in a pointer to a thread, and directs that thread to
